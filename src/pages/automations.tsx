    ...
    <>
      ...
      <main className="py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-3xl">
            {automations.subheading}
          </p>
        </div>

        {/* Pricing Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {automations.plans.map((plan, index) => (
            <div
              key={index}
        ...
        <div className="mb-20 border border-zinc-500 p-8 bg-gray-50 dark:bg-zinc-800">
          <h2 className="text-3xl font-semibold mb-6 text-customBlack dark:text-white">
            {automations.whatsIncluded.title}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {automations.whatsIncluded.items.map((item, index) => (
        ...
        <div className="mb-20">
          <h2 className="text-3xl font-semibold mb-4 text-customBlack dark:text-white">
            {automations.caseStudies.title}
          </h2>
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
            {automations.caseStudies.subtitle}
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {automations.caseStudies.studies.map((study, index) => (
              <div
                key={index}
        ...
        <div className="mb-20">
          ...
          <div className="space-y-4">
            {automations.faq.map((item, index) => (
              <div
                key={index}
        ...
        <div className="border border-zinc-500 p-12 bg-white dark:bg-zinc-900 text-center">
          <h2 className="text-3xl font-semibold mb-4 text-customBlack dark:text-white">
            {automations.cta.title}
          </h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto">
            {automations.cta.description}
          </p>
          <button
            onClick={openModal}
