...
const Development = () => {
  ...
  return (
    <>
      <CustomMainPagesHead name="Development | Shinerock Labs" type="" />
      <main className="py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {development.plans.map((plan, index) => (
            <div
              key={index}
        ...
        <div className="mb-20 border border-zinc-500 p-8 bg-gray-50 dark:bg-zinc-800">
          <h2 className="text-3xl font-semibold mb-6 text-customBlack dark:text-white">
            {development.whatsIncluded.title}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {development.whatsIncluded.items.map((item, index) => (
        ...
        <div className="mb-20">
          <h2 className="text-3xl font-semibold mb-4 text-customBlack dark:text-white">
            {development.caseStudies.title}
          </h2>
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
            {development.caseStudies.subtitle}
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {development.caseStudies.studies.map((study, index) => (
              <div
                key={index}
        ...
        <div className="mb-20">
          ...
          <div className="space-y-4">
            {development.faq.map((item, index) => (
              <div
                key={index}
